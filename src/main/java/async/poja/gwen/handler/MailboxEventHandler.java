package async.poja.gwen.handler;

import static async.poja.gwen.concurrency.ThreadRenamer.renameWorkerThread;
import static java.lang.Runtime.getRuntime;
import static java.lang.System.getenv;
import static java.lang.Thread.currentThread;

import async.poja.gwen.PojaApplication;
import async.poja.gwen.PojaGenerated;
import async.poja.gwen.endpoint.EndpointConf;
import async.poja.gwen.endpoint.event.EventConf;
import async.poja.gwen.endpoint.event.consumer.EventConsumer;
import async.poja.gwen.endpoint.event.consumer.model.ConsumableEvent;
import async.poja.gwen.endpoint.event.consumer.model.ConsumableEventTyper;
