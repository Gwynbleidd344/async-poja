package async.poja.gwen.concurrency;

import static async.poja.gwen.concurrency.ThreadRenamer.getRandomSubThreadNamePrefixFrom;
import static async.poja.gwen.concurrency.ThreadRenamer.renameThread;
