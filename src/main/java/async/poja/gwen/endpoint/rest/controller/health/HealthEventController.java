package async.poja.gwen.endpoint.rest.controller.health;

import static async.poja.gwen.endpoint.rest.controller.health.PingController.KO;
import static async.poja.gwen.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import async.poja.gwen.PojaGenerated;
import async.poja.gwen.endpoint.event.EventProducer;
import async.poja.gwen.endpoint.event.model.DurablyFallibleUuidCreated1;
import async.poja.gwen.endpoint.event.model.UuidCreated;
import async.poja.gwen.repository.DummyUuidRepository;
import async.poja.gwen.repository.model.DummyUuid;
