package async.poja.gwen.endpoint.event.consumer;

import async.poja.gwen.PojaGenerated;
import async.poja.gwen.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("async.poja.gwen.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "async.poja.gwen.service.event."
